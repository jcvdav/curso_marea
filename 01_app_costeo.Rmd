...
[COBI](https://cobi.org.mx/) ha trabajado durante 19 años para establecer, evaluar y mantener las reservas marinas en colaboración con las comunidades pesqueras de México. Nuestro modelo de reservas marinas consiste de cuatro fases:
...
knitr::include_app("https://turfeffect.shinyapps.io/AppCosteo/", 
  height = "500px")
```
